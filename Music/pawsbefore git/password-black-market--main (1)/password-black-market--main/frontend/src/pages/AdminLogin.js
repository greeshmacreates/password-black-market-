  ...
  return (
    <div className="auth-wrap">
      <form className="auth-card" onSubmit={submit} autoComplete="off">
        ...
        <input className="auth-input mono" name="admin-id-no-autofill" autoComplete="off" placeholder="Enter Admin ID" value={teamId} onChange={(e) => setTeamId(e.target.value.toUpperCase())} />
